let allImageCollection = ((async () => {
    let fetchDataCollectionFromServer = await fetch('https://tboss09.github.io/data/gallery.json');// This fetches the data from github Server hosted on github
                    ...
                    <div class="item-wrapper">
                        <div class="item-img">
                            <a href="easter-festive.html?id=${elem.id}"><img src="https://cdn.statically.io/gh/Tboss09/mcttImages/bcc113aa/${elem["images"][idx]}"
                                    alt="${elem.alt}" data-slide-to="1"></a>
                        </div>
